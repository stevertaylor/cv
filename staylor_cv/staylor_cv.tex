...
\hspace{0.71cm} Co-mentor for summer research project: \textit{``Advanced pulsar noise modeling and cross-validation''}. %\vspace{-0.1cm}
...
%
\cvitemwithcomment{}{\hspace{0.4cm}${\color{color1} \circ}\;$ LISA Consortium, \textit{Scientist Member} ({\color{color1} \href{https://www.elisascience.org/sc-profiles/srtaylor}{https://www.elisascience.org/sc-profiles/srtaylor}})}{} \vspace{-0.1cm}
