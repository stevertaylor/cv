...
$\bullet$ \textbf{Full list of presentations} given below, and at {\color{color1} \href{http://bit.ly/2fqo9BA}{http://bit.ly/2fqo9BA}}.
...
\textbf{4.} & & ``\textit{Single Sources in the Low-Frequency Gravitational Wave Sky: properties and time to detection by pulsar timing arrays}'' \\ 
&&L.~Z.~Kelley, L.~Blecha, L.~Hernquist, A.~Sesana, \textbf{S.~R.~Taylor} \\
&& Submitted to {\color{color1} MNRAS}. \href{https://arxiv.org/abs/1711.00075}{{\color{color1} arXiv:1711.00075}} \vspace{0.09cm}\\
...
\vspace{-0.3cm}
\subsection{Invited talks} \vspace{-0.7cm}
...
\vspace{-0.7cm}
\subsection{Contributed presentations} \vspace{-0.7cm}
...
\vspace{-0.7cm}
\subsection{Posters} \vspace{-0.7cm}
