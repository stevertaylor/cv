...
{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{32} papers published in major peer-reviewed journals} \\
& &{(out of which \textbf{11} are first-authored papers, and \textbf{3} papers were covered by press releases).}
\end{tabular}
}

$\bullet$ \textbf{Total number of citations:} 1101 (using Google Scholar), \textbf{h-index:} 19, \textbf{i10-index:} 25
...
\cvitemwithcomment{}{\hspace{0.4cm}${\color{color1} \circ}\;$ \textit{Sophia Singh}, University of Southern California}{Fall 2018--}\vspace{-0.1cm}
...
\hspace{0.71cm} Advisor for research project: \textit{``Advanced pulsar noise modeling and cross-validation''}. %\vspace{-0.1cm}
...
\cvitemwithcomment{}{\hspace{0.4cm}${\color{color1} \circ}\;$ NASA Graduate Fellowship Program (NESSF)}{} \vspace{-0.1cm}
...
\cvitem{}{\small
\hspace{-2cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
\textbf{32.} & & ``\textit{Mining Gravitational-wave Catalogs To Understand Binary Stellar Evolution: A New Hierarchical Bayesian Framework}'' \\ 
&&\textit{\textbf{S.~R.~Taylor}} and D.~Gerosa \\
&& \href{https://arxiv.org/abs/1806.08365}{{\color{color1} Accepted and in press. Phys.~Rev.~D, arXiv:1806.08365 (2018)}}  \vspace{0.09cm}\\
...
&&S.~J.~Vigeland, K.~P.~Islo, \textit{\textbf{S.~R.~Taylor}}, J.~A.~Ellis \\
