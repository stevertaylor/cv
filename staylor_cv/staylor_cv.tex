...
\textbf{2.} & & ``\textit{Mining Gravitational-wave Catalogs To Understand Binary Stellar Evolution: A New Hierarchical Bayesian Framework}'' \\ 
&&\textbf{S.~R.~Taylor}, D.~Gerosa \\
&& \href{https://arxiv.org/abs/1806.08365}{{\color{color1} Submitted to Phys.~Rev.~D, arXiv:1806.08365}}  \vspace{0.09cm}\\
\textbf{1.} & & ``\textit{The noise-marginalized optimal statistic: A robust hybrid frequentist-Bayesian statistic for the stochastic gravitational-wave background in pulsar timing arrays}'' \\ 
&&S.~J.~Vigeland, K.~P.~Islo, \textbf{S.~R.~Taylor}, J.~A.~Ellis \\
&& \href{https://arxiv.org/abs/1805.12188}{{\color{color1} Submitted to Phys.~Rev.~D, arXiv:1805.12188}}  %\vspace{0.09cm}\\
\end{longtable}
}
