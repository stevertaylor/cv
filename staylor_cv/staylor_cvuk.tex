...
\item My future goals are to perform full model-independent recoveries of the parameter \textbf{demographics of LIGO-detected systems}, as well as investigating their progenitor properties. 
\end{itemize}
